...
describe('lib', function () {
	describe('ProfitTable', function () {
		describe('computeRanking', function () {
			it('should compute ranking for one trader', function () {
			...
			it('should compute ranking for two traders', function () {
				const table = new ProfitTable();
